...
bool JointImpedanceController::init(hardware_interface::EffortJointInterface *robot, ros::NodeHandle &n)
{
   // KinematicChainControllerBase<hardware_interface::EffortJointInterface>::init(robot, n);
    std::cout<< "finished initialising KinematicChainControllerBase" << std::endl;

    std::cout<< "number of joints: " << kdl_chain_.getNrOfJoints() << std::endl;
